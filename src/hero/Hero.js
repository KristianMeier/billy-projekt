...
const Hero = () => {
  return (
    <div className='lp-components-container'>
      <div className='lp-component themed theme-blue-warm-white full-width no-margin-top nav-scroll-limit-trigger-element'>
        <div className='lp-component-container container'>
          <div className='lp-wave-hero-themed'>
            <div className='content-image-container'>
              <div className='hero-content'>
                <h1 className=' ds-text ds-align-left ds-color-darkGrey ds-variant-h1 ds-weight-normal'>
                  Regnskabsprogrammet selvstændige anbefaler
                </h1>
                <div className='themed-rich-text'>
                  <p className=''>
                    Billy er skræddersyet til selvstændige samt små og
                    mellemstore virksomheder. Send professionelle fakturaer,
                    bogfør regninger og afregn moms med få klik.
                  </p>
                </div>
                <form id='front-page-signup-form' className='signup-form'>
                  <div className='form-inputs'>
                    ...
                    <div className='form-group '>
                      <div className='input-visibility-icon-container'>
                        <input
                          name='password'
                          type='password'
                          placeholder='...og vælg dit kodeord'
                          autoComplete='new-password'
                          className='signup-input'
                        />
                        <img
                    ...
                    <button
                      className=' ds-button signup-submit-button false cta-primary ds-variant-secondary ds-inverted'
                      type='submit'
                  ...
                  <div className='form-controls form-conditions form-group terms-errors-container'>
                      ...
                      <label className='checkbox-container'>
                        ...
                        <span className='accept-label'>
                          ...
                          <a
                            ...
                            className='ds-link terms-link ds-underline'
                          >
                            forretningsbetingelser
                          </a>
                          og
                          <a
                            href='https://www.billy.dk/databehandleraftale/'
                            className='link__StyledLink-sc-l68dci-0 ifeGHq ds-link terms-link ds-underline'
                          >
                            databehandleraftale
                          </a>
                          *
                    ...
                    <div className='terms-container'>
                      <label className='checkbox-container'>
                        ...
                        <span className='accept-label'>
                          Acceptér Billys mails med nyheder, opdateringer og
                          tilbud
                        </span>
                      </label>
                    </div>
              ...
              <div id='tp-widget-wrapper' className='tp-widget-wrapper visible'>
                <div className='tp-widget-customerssay'>
                  <a
                    className='profile-url'
                    href='https://dk.trustpilot.com/review/www.billy.dk?utm_medium=trustbox&amp;utm_source=Horizontal'
                  >
                    <span id='translations-customerssay'>
                      Vores kunder siger
                    </span>
                  </a>
                </div>
                ...
                <div id='tp-widget-rating' className='tp-widget-rating'>
                  <strong>4.8</strong> ud af 5 baseret på
                  <strong>1.961 anmeldelser</strong>
                </div>
                <div className='tp-widget-poweredby'>
              ...
              <div className='hero-image-container'>
                <img
                  ...
                  loading='lazy'
                  alt='Regnskabsprogrammet selvstændige anbefaler'
